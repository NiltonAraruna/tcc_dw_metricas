...
De acordo com a \citeonline{ISO:12207}, contrato é o acordo realizado entre duas partes, respaldado pela lei, ou acordo interno similar restrito a uma organização, para o fornecimento de serviços de software ou para o desenvolvimento, produção, operação ou manutenção de um produto de software.
...
\begin{figure}[h!]
\centering
\includegraphics[keepaspectratio=false,scale=0.4]{figuras/figuras_nilton/atividadesAquisicao.eps}
...
\todo[inline, backgroundcolor=yellow!20!white, bordercolor=red]{Nilton, insira um parágrafo associando as idéias do capítulo de métricas com os artigos da IN4 citados. Do ponto de vista do leitor, faltou a coesão textual. O leitor é obrigado a inferir a relação entre métricas de código-fonte e a IN4.}
