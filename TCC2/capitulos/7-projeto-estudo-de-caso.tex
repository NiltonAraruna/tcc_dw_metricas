...
\textbf{Objetivo 01:} Realizar um estudo de caso onde será analisado o uso de um ambiente de Data Warehousing para o monitoramento de métricas, \textit{bugs }e violações de código fonte de forma a assistir ao processo de aferição de qualidade interna dos produtos de software desenvolvidos por uma organização terceirizada e adquerido pela CAIXA.\\
...
\textbf{Métrica:} Ótimo, Muito Bom, Bom, Ruim, Muito Ruim. \\
...
\textbf{QE05: } Qual a opinião da equipe do CETEC/GITECGO quanto a visualização de violações de código(PMD) através do \textit{dashboard}?
...
\textbf{QE06: } Qual a opinião da equipe do CETEC/GITECGO quanto a visualização de bugs(findbugs) através do \textit{dashboard}?
...
\textbf{QE07: } Qual a opinião da equipe do CETEC/GITECGO do uso do DW em comparação à solução do sonarQube?
...
\textbf{Métrica:} Coeficiente de correlação Linear e Diagramas de Dispersão.\\
...
% Objetivo 02
\textbf{Objetivo 02:} Automatizar o processo de análise de \textit{bugs} e violações de código- fonte.\\

% Questão 01

\textbf{QE01: } Como automatizar a análise de violações de código- fonte?

\textbf{Fonte:} {\color{red}capitulo X}.

\textbf{Métrica:} Quantidade de passos automatizados.\\

% Questão 02

\textbf{QE02: } Como automatizar a análise de \textit{bugs} de código- fonte? 
...
Esse capítulo teve como objetivo apresentar o protocolo de estudo de caso que foi adotado neste trabalho. No próximo capítulo será apresentado a execução do Estudo de Caso e a análise dos Dados.