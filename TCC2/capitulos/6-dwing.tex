...
Load} na ferramenta \textit{Kettle} foi descrita no Apêndice \ref{sec:implementação-etl}. Já o Apêndice \ref{sec:implementação-dashboard} traz a descrição da implementação do \textit{dashboard}.
