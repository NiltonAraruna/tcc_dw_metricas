...
--
-- criando tabelas para o cubo de Bugs`
--

CREATE TABLE IF NOT EXISTS `D_Priority` (
...
--
-- Fazendo dump de dados para tabela `D_Priority`
--

INSERT INTO `D_Priority` (`idPriority`, `priority_name`) VALUES
(1, 'alta'),
(2, 'media'),
(3, 'baixa');


CREATE TABLE IF NOT EXISTS `D_Class_Bug` (
  `idClass_bug` int(11) NOT NULL,
  `bug_package_class` varchar(200) DEFAULT NULL,
  `bug_file_class` varchar(200) DEFAULT NULL,
  `bug_line_class` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`idClass_bug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `D_Type` (
  ...
  `type_abreviation` varchar(200) DEFAULT NULL,
  `type_category` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`idType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Fazendo dump de dados para tabela `D_Type`
--


INSERT INTO `D_Type` VALUES (2,'       /EC_UNRELATED_TYPES','EC','CORRECTNESS'),(3,'       /SE_BAD_FIELD','Se','BAD_PRACTICE'),(4,'DB_DUPLICATE_BRANCHES','DB','STYLE'),(5,'DLS_DEAD_LOCAL_STORE','DLS','STYLE'),(6,'DM_CONVERT_CASE','Dm','I18N'),(7,'DM_NUMBER_CTOR','Bx','PERFORMANCE'),(8,'EC_UNRELATED_TYPES','EC','CORRECTNESS'),(9,'EI_EXPOSE_REP','EI','MALICIOUS_CODE'),(10,'EI_EXPOSE_REP2','EI2','MALICIOUS_CODE'),(11,'HE_EQUALS_USE_HASHCODE','HE','BAD_PRACTICE'),(12,'ME_ENUM_FIELD_SETTER','ME','BAD_PRACTICE'),(13,'NM_FIELD_NAMING_CONVENTION','Nm','BAD_PRACTICE'),(14,'NP_LOAD_OF_KNOWN_NULL_VALUE','NP','STYLE'),(15,'NP_NULL_ON_SOME_PATH','NP','CORRECTNESS'),(16,'RCN_REDUNDANT_NULLCHECK_OF_NONNULL_VALUE','RCN','STYLE'),(17,'RCN_REDUNDANT_NULLCHECK_OF_NULL_VALUE','RCN','STYLE'),(18,'REC_CATCH_EXCEPTION','REC','STYLE'),(19,'RV_RETURN_VALUE_IGNORED_NO_SIDE_EFFECT','RV','STYLE'),(20,'SE_BAD_FIELD','Se','BAD_PRACTICE'),(21,'SS_SHOULD_BE_STATIC','SS','PERFORMANCE'),(22,'UCF_USELESS_CONTROL_FLOW','UCF','STYLE'),(23,'       /RC_REF_COMPARISON','RC','CORRECTNESS'),(24,'RC_REF_COMPARISON','RC','CORRECTNESS'),(25,'       /ES_COMPARING_PARAMETER_STRING_WITH_EQ','ES','BAD_PRACTICE'),(26,'ES_COMPARING_PARAMETER_STRING_WITH_EQ','ES','BAD_PRACTICE'),(27,'RCN_REDUNDANT_NULLCHECK_WOULD_HAVE_BEEN_A_NPE','RCN','CORRECTNESS'),(28,'UPM_UNCALLED_PRIVATE_METHOD','UPM','PERFORMANCE'),(29,'       /ES_COMPARING_STRINGS_WITH_EQ','ES','BAD_PRACTICE'),(30,'ES_COMPARING_STRINGS_WITH_EQ','ES','BAD_PRACTICE'),(31,'WMI_WRONG_MAP_ITERATOR','WMI','PERFORMANCE'),(32,'BX_UNBOXING_IMMEDIATELY_REBOXED','Bx','PERFORMANCE'),(33,'DE_MIGHT_IGNORE','DE','BAD_PRACTICE'),(34,'RpC_REPEATED_CONDITIONAL_TEST','RpC','CORRECTNESS'),(35,'SIC_INNER_SHOULD_BE_STATIC_ANON','SIC','PERFORMANCE');
...
CREATE TABLE IF NOT EXISTS `F_Rate_Scenario` (
  ...
  `Quantiy_Bugs` double DEFAULT NULL,
  `D_Project_idProject` int(11) NOT NULL,
  `D_Release_idRelease` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `F_Project_Violation` (
  ...
  KEY `fk_F_Project_Violation_D_Severite1_idx` (`D_Class_Violation_idSeverite`),
  KEY `fk_F_Project_Violation_D_Project1_idx` (`D_Project_idProject`),
...
--
-- Criando fato do cubo de Bug`
--

CREATE TABLE IF NOT EXISTS `F_Project_Bug` (
  `idProjectBug` int(11) NOT NULL AUTO_INCREMENT,
  `quantiy_Bug` double DEFAULT NULL,
  `D_Class_Bug_idClass_Bug` int(11) NOT NULL,
  `D_Class_Bug_idType` int(11) NOT NULL,
  `D_Class_Bug_idPriority` int(11) NOT NULL,
  `D_Project_idProject` int(11) NOT NULL,
  `D_Release_idRelease` int(11) NOT NULL,
  `D_Time_idTime` int(11) NOT NULL,
  PRIMARY KEY (`idProjectBug`),
  KEY `fk_F_Project_Bug_D_Class_Bug1_idx` (`D_Class_Bug_idClass_Bug`),
  KEY `fk_F_Project_Bug_D_Type1_idx` (`D_Class_Bug_idType`),
  KEY `fk_F_Project_Bug_D_Priority1_idx` (`D_Class_Bug_idPriority`),
  KEY `fk_F_Project_Bug_D_Project1_idx` (`D_Project_idProject`),
  KEY `fk_F_Project_Bug_D_Release1_idx` (`D_Release_idRelease`),
  KEY `fk_F_Project_Bug_D_Time1_idx` (`D_Time_idTime`)

) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6400;
...
--
-- Restrições para tabelas `F_Project_Bug`
--

ALTER TABLE `F_Project_Bug`
  ADD CONSTRAINT `fk_F_Project_Bug_D_Class_Bug1` FOREIGN KEY (`D_Class_Bug_idClass_Bug`) REFERENCES `D_Class_Bug` (`idClass_Bug`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_F_Project_Bug_D_Type1` FOREIGN KEY (`D_Class_Bug_idType`) REFERENCES `D_Type` (`idType`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_F_Project_Bug_D_Priority1` FOREIGN KEY (`D_Class_Bug_idPriority`) REFERENCES `D_Priority` (`idPriority`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_F_Project_Bug_D_Project1` FOREIGN KEY (`D_Project_idProject`) REFERENCES `D_Project` (`idProject`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_F_Project_Bug_D_Release1` FOREIGN KEY (`D_Release_idRelease`) REFERENCES `D_Release` (`idRelease`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_F_Project_Bug_D_Time1` FOREIGN KEY (`D_Time_idTime`) REFERENCES `D_Time` (`idTime`) ON DELETE NO ACTION ON UPDATE NO ACTION;
